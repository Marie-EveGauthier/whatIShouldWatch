...
character_list5.csv) to calculates the percentages of male and female dialogue for
...
complete_movie_data = [['id', 'title', 'year', 'f_percent', 'm_percent', 'bechdel', 'imdb_id']]
